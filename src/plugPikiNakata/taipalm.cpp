...
void TaiPalmStrategy::start(Teki& teki)
{
	...
	TekiCreaturePointerCondition selfCondition(&teki);
	TekiNotCondition notSelfCondition(&selfCondition);
	TekiTypeCondition typeCondition(teki.mTekiType);
	TekiDistanceCondition distanceCondition(&teki, rad);
	TekiAndCondition typeAndDistanceCondition(&typeCondition, &distanceCondition);
	TekiAndCondition NRef cond = TekiAndCondition(&notSelfCondition, &typeAndDistanceCondition);
